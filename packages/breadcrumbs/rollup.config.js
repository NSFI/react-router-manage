...
const name = packageName.replace(/@rrm\//, '')
  ...
  const webModules = [
    {
      input: `${SOURCE_DIR}/index.tsx`,
      output: {
        file: `${OUTPUT_DIR}/breadcrumbs.development.js`,
        format: "esm",
        sourcemap: !PRETTY,
        banner: createBanner(
          "React Router Manage Breadcrumbs for antd",
    ...
    },
    {
      input: `${SOURCE_DIR}/index.tsx`,
      output: {
        file: `${OUTPUT_DIR}/breadcrumbs.production.min.js`,
        format: "esm",
        sourcemap: !PRETTY,
        banner: createBanner(
          "React Router Manage Breadcrumbs for antd",
  ...
  const globals = [
    {
      input: `${SOURCE_DIR}/index.tsx`,
      output: {
        file: `${OUTPUT_DIR}/umd/breadcrumbs.development.js`,
        format: "umd",
        sourcemap: !PRETTY,
        banner: createBanner(
          "React Router Manage Breadcrumbs for antd",
    ...
    },
    {
      input: `${SOURCE_DIR}/index.tsx`,
      output: {
        file: `${OUTPUT_DIR}/umd/breadcrumbs.production.min.js`,
        format: "umd",
        sourcemap: !PRETTY,
        banner: createBanner(
          "React Router Manage Breadcrumbs for antd",
