...
import {MRouter, useAddRoutes, useRemoveRoutes, useUpdateRoutes } from '../packages/react-router-manage/index';
...
describe("路由增删改测试", () => {
    ...
    it('在PAGE1添加路由正常渲染', async() => {
        ...
        render(<MRouter wrapComponent={AddRoutesWrapComponent} routerConfig={appRouterConfig} hasAuth={false}></MRouter>);
    ...
    it('在根路径添加路由正常渲染', async() => {
        ...
        render(<MRouter wrapComponent={AddRouteRoutesWrapComponent} routerConfig={appRouterConfig} hasAuth={false}></MRouter>);
    ...
    it('删除路由正常渲染', () => {
        ...
        render(<MRouter wrapComponent={RemoveRoutesWrapComponent} routerConfig={appRouterConfig}  hasAuth={false}></MRouter>);
    ...
    it('删除跟路由下的路由', () => {
        history.pushState({}, '', '/a/page1');
        render(<MRouter wrapComponent={RemoveRootRoutesWrapComponent} routerConfig={appRouterConfig}  hasAuth={false}></MRouter>);
    ...
    it('修改路由正常渲染', () => {
        history.pushState({}, '', '/a/page1');
        render(<MRouter wrapComponent={UpdateRoutesWrapComponent} routerConfig={appRouterConfig} hasAuth={false}></MRouter>);
