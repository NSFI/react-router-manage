...
export const Page = () => {
  ...
  return (
    <div>
      <span>当前所在路由 {currentRoute.title}</span>
      <Button
        data-testid="__test_button"
        onClick={() => navigate(routesMap.PAGE2.path)}
      >
        跳转到page2
      </Button>
      <Button
        data-testid="__test_button_params"
        onClick={() =>
          navigate(routesMap.PAGE5.path, { params: { id: "apps" } })
        }
      >
        跳转到page5
      </Button>
